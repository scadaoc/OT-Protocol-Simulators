...
A Modbus TCP/RTU server simulator built with **pymodbus 3.12.x**, used as the lab target for the [Caldera-OT blog series](https://medium.com/@laiqkhan559) on Medium.
